...
.L080AA9FA:
    ...
    b .L080AAA2C
.L080AAA04:
    ldr r0, .L080AAA0C @ =gDispIo
    ldrh r0, [r0, #0x1c]
    b .L080AAA2C
    .align 2, 0
.L080AAA0C: .4byte gDispIo
.L080AAA10:
    ldr r0, .L080AAA18 @ =gDispIo
    ldrh r0, [r0, #0x20]
    b .L080AAA2C
    .align 2, 0
.L080AAA18: .4byte gDispIo
.L080AAA1C:
    ldr r0, .L080AAA24 @ =gDispIo
    ldrh r0, [r0, #0x24]
    b .L080AAA2C
    .align 2, 0
.L080AAA24: .4byte gDispIo
.L080AAA28:
    ldr r0, .L080AAA30 @ =gDispIo
    ldrh r0, [r0, #0x28]
.L080AAA2C:
    bx lr
    .align 2, 0
.L080AAA30: .4byte gDispIo
...
.L080AAA42:
    ...
    b .L080AAA74
.L080AAA4C:
    ldr r0, .L080AAA54 @ =gDispIo
    ldrh r0, [r0, #0x1e]
    b .L080AAA74
    .align 2, 0
.L080AAA54: .4byte gDispIo
.L080AAA58:
    ldr r0, .L080AAA60 @ =gDispIo
    ldrh r0, [r0, #0x22]
    b .L080AAA74
    .align 2, 0
.L080AAA60: .4byte gDispIo
.L080AAA64:
    ldr r0, .L080AAA6C @ =gDispIo
    ldrh r0, [r0, #0x26]
    b .L080AAA74
    .align 2, 0
.L080AAA6C: .4byte gDispIo
.L080AAA70:
    ldr r0, .L080AAA78 @ =gDispIo
    ldrh r0, [r0, #0x2a]
.L080AAA74:
    bx lr
    .align 2, 0
.L080AAA78: .4byte gDispIo
...
.L080BAF5E:
    ...
    b .L080BAFB4
    .align 2, 0
.L080BAF88: .4byte gDispIo
.L080BAF8C:
    ldr r3, .L080BAFC8 @ =gDispIo
    adds r2, r3, #0
    adds r2, #0x3c
    movs r0, #0x3f
    ldrb r1, [r2]
